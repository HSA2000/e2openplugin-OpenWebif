...
#                                                                            #
##############################################################################
# 2014.07.15 01:23:51 CEST
#Embedded file name: usr/lib/enigma2/python/Plugins/Extensions/OpenWebif/controllers/models/message.py
...
def sendMessage(session, message, ttype, timeout):
    global lastreply
    if ttype not in [MessageBox.TYPE_YESNO,
